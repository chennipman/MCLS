...
/********************************************************************************/
    void advance_flow_field(
	 ...
	 int maximum_iterations_allowed_velocity
      ...
      void shift_velocity_field(			     // shift the velocity fields
          double ***u_1_velocity_old, 		             // u new -> u old
          double ***u_2_velocity_old, 		             // u star -> u new
          double ***u_3_velocity_old,		
    ...
    /* allocate memory for tentative velocity field u star */
      ...
      u_1_velocity_star=double_Matrix2(number_primary_cells_i+1, number_primary_cells_j+2, number_primary_cells_k+2);
      u_2_velocity_star=double_Matrix2(number_primary_cells_i+2, number_primary_cells_j+1, number_primary_cells_k+2);
      u_3_velocity_star=double_Matrix2(number_primary_cells_i+2, number_primary_cells_j+2, number_primary_cells_k+1);
	...
	free_double_Matrix2(u_1_velocity_star,number_primary_cells_i+1, number_primary_cells_j+2);
	free_double_Matrix2(u_2_velocity_star,number_primary_cells_i+2, number_primary_cells_j+1);
	free_double_Matrix2(u_3_velocity_star,number_primary_cells_i+2, number_primary_cells_j+2);
