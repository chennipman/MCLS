...
/********************************************************************************/
/********************************************************************************/
/*  Function to compute the first stage of three stage Runge-Kutta method       */
...
/********************************************************************************/
//
EXPORT void compute_first_stage_RK(
    Array3<double> level_set,                        // level set at previous time level
      ...
      for(i_index=1;i_index<number_primary_cells_i+1;i_index++)
      {
            for(j_index=1;j_index<number_primary_cells_j+1;j_index++)
            {
                   for(k_index=1;k_index<number_primary_cells_k+1;k_index++)
                   {
                        ...
                        level_set_stage_1[i_index  ][j_index][k_index]=
