...
//
	...
	double ***level_set, 			// fluxes in x2 direction
	...
	double lower_bound_derivatives    		
     ...
     /* allocate temporary storage for the fluxes */
      ...
      flux_x2=double_Matrix2(number_primary_cells_i+2, number_primary_cells_j+1,
...
/* de-allocate the temporary storage for the fluxes */
      ...
      free_double_Matrix2(flux_x2, number_primary_cells_i+2, number_primary_cells_j+1);
      }
