...
/********************************************************************************/
    ...
    void build_momentum_matrix_u1(
      Array2<double> momentum_matrix_u1,			// build matrix for the momentum equation
      Array3<double> level_set, 				// for the velocity in x1 direction
    ...
    void build_momentum_rhs_u1(
      Array1<double> momentum_rhside_u1,			// build rhside for the momentum equation
      Array3<double> level_set, 				// for the velocity in x1 direction
      Array3<double> scaled_density_u1,
  ...
  void fold_momentum_rhside_u1(
      ...
      Array1<double> momentum_rhside_u1,			// rhside of the momentum equation 
      Array2<double> momentum_matrix_u1,			// velocity in x1 direction
      int number_primary_cells_i,			 
      int number_primary_cells_j,			 
      int number_primary_cells_k,			 
      double mesh_width_x1,				 
  ...
  void fold_momentum_matrix_u1(
      boundary_face boundary_faces[6],			// apply boundary conditions for the
      Array2<double> momentum_matrix_u1,			// matrix of the momentum equation
