...
EXPORT int map_index_u2(
      ...
      )
  {
    ...
    /* in construction of the matrix and rhside for the u_2 matrix the */
    /* i and k index run from 1 to number_primary_cells_i/k to have a  */
    /* nice correspondence with the fields that do include the virtual */
    /* cells							       */
    
    one_dimensional_index=(i_index-1)+j_index*number_primary_cells_i+
		(k_index-1)*(number_primary_cells_i*(number_primary_cells_j+1));
