...
/********************************************************************************/
    ...
    void build_momentum_matrix_u2(
      double **momentum_matrix_u2,			// build matrix for the momentum equation
      double ***level_set, 				// for the velocity in x2 direction
    ...
    void build_momentum_rhs_u2(
      double *momentum_rhside_u2,			// build rhside for the momentum equation
      double ***level_set, 				// for the velocity in x2 direction
      double ***scaled_density_u2,
  ...
  void fold_momentum_rhside_u2(
      ...
      double *momentum_rhside_u2,			// rhside of the momentum equation 
      double **momentum_matrix_u2,			// velocity in x2 direction
      int number_primary_cells_i,			 
      int number_primary_cells_j,			 
      int number_primary_cells_k,			 
      double mesh_width_x1,				 
  ...
  void fold_momentum_matrix_u2(
      boundary_face boundary_faces[6],			// apply boundary conditions for the
      double **momentum_matrix_u2,			// matrix of the momentum equation
