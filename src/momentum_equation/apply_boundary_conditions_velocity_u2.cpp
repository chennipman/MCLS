	...
	int boundary_var = 1; 
	  ...
	  if(boundary_faces[face_index].boundary_variables[1].boundary_condition_type==dirichlet)
	  {
		 ...
		 for(j_index=0;j_index<number_primary_cells_j+1;j_index++)
		 {
			...
			u_2_velocity[cell_label_boundary][j_index][k_index]=
			    2.0*boundary_value
			    -u_2_velocity[cell_label_boundary+increment_label_adjacent][j_index][k_index];
		      }	  
	  ...
	  else
	  {
		 ...
		 for(j_index=0;j_index<number_primary_cells_j+1;j_index++)
		 {
		  ...
		  std::cout<< "in apply_boundary_conditions_velocity_u2, setting I-face  \n";
		  exit(1);
	      }
	  }
	  ...
	  {
	   std::cout<< "this is not implemented yet, check your input, aborting...\n";
		  std::cout<< "in apply_boundary_conditions_velocity_u2, setting J-face \n";
	   exit(1);
	  }
	  ...
	  if(boundary_faces[face_index].boundary_variables[1].boundary_condition_type==dirichlet)
	  {
		...
		/* U_virtual=2*U_boundary - U_real */
		 for(i_index=0;i_index<number_primary_cells_i+2;i_index++)
		 {
			...
			u_2_velocity[i_index][j_index][cell_label_boundary]=
			    2.0*boundary_value
			    -u_2_velocity[i_index][j_index][cell_label_boundary+increment_label_adjacent];
		      }	  
	  ...
	  else
	  {
		 ...
		 for(i_index=0;i_index<number_primary_cells_i+2;i_index++)
		 {
		  ...
		  std::cout<< "this is not implemented yet, check your input, aborting...\n";
		  std::cout<< "in apply_boundary_conditions_velocity_u2, setting K-face \n";
		  exit(1);
	      }
	  }
