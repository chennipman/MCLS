/* set all the information on the boundary */
/*
Face 0: n=( 1, 0, 0)
Face 1: n=(-1, 0, 0)
Face 2: n=( 0, 1, 0)
...
// boundary condition type: homogeneous dirichlet
    ...
    boundary_faces[0].boundary_variables[0].cell_centering=vertex_centered;
...
// boundary condition type: homogeneous dirichlet
    ...
    boundary_faces[1].boundary_variables[0].cell_centering=vertex_centered;
...
// boundary condition type: homogeneous dirichlet
    ...
    boundary_faces[2].boundary_variables[1].cell_centering=vertex_centered;
...
// boundary condition type: homogeneous dirichlet
    ...
    boundary_faces[3].boundary_variables[1].cell_centering=vertex_centered;
...
// boundary condition type: homogeneous dirichlet
    ...
    boundary_faces[4].boundary_variables[2].cell_centering=vertex_centered;
...
// boundary condition type: homogeneous dirichlet
    ...
    boundary_faces[5].boundary_variables[2].cell_centering=vertex_centered;
