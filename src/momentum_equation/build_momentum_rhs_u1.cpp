...
/********************************************************************************/
/*  Function to build momentum right hand side for the u1 velocity, without     */
/*  boundary conditions								*/
/*  											*/
...
// 					 rho_plus_over_rho_minus);
		  ...
		  u_1_velocity_cell_center=u_1_velocity_old[i_index][j_index][k_index];
		  u_2_velocity_cell_center=0.25*(
					   ...
					   u_2_velocity_old[i_index+1][j_index-1][k_index  ]
					     );
		  u_3_velocity_cell_center=0.25*(
					   ...
					   u_3_velocity_old[i_index+1][j_index  ][k_index-1]
					     );
			      ...
			      compute_convection_term(u_1_velocity_cell_center,
							u_2_velocity_cell_center,
							  u_3_velocity_cell_center,
							      ...
							      u_1_velocity_old[i_index  ][j_index  ][k_index+1],
							      2*mesh_width_x1, mesh_width_x2, mesh_width_x3				
 						    );
		 }
		 else
		 {
		...
		/* evaluate the explicit part of the diffusion part of the momentum equation */
		  ...
		  diffusion_term=
		   ...
		   one_dimensional_index=map_index_u1(i_index,j_index,k_index,
		    ...
		    momentum_rhside_u1[one_dimensional_index]=
			density_cell_center*u_1_velocity_old[i_index][j_index][k_index]+
			  actual_time_step_navier_stokes*(-1.0*convection_term+
				    diffusion_term + 
				      density_cell_center*momentum_source_term_u_1[i_index][j_index][k_index]);
	      }  
	  }  
      }  
  }      
