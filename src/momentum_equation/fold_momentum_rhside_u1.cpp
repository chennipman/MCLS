      ...
      
{
   ...
   /* start the loop over all faces for the rhside folding */
	  ...
	  boundary_value=boundary_faces[face_index].boundary_variables[0].boundary_condition_value;
...
// 		{
			...
			/* U_real=U_boundary */
			    ...
			    momentum_rhside_u1[one_dimensional_index]=boundary_value;
			}	  
...
// 		}
	  ...
	  else
	  {
	      ...
	      std::cerr<<"in function fold_momentum_rhside_u1 line 193 \n";
	      std::cerr<<"**************************************************** \n";
	      exit(1);
	  }
	  ...
	  else
	  {
		...
		else
		{
		  ...
		  std::cerr<<"you are trying to impose a boundary condition that \n";
		  std::cerr<<"is not implemented yet, check your input";
		  std::cerr<<"in function fold_momentum_rhside_u1 line 327 \n";
		  std::cerr<<"**************************************************** \n";
		  exit(1);
	      }
	  }
	  ...
	  else
	  {
		 ...
		 else
		 {
		  ...
		  std::cerr<<"you are trying to impose a boundary condition that \n";
		  std::cerr<<"is not implemented yet, check your input";
		  std::cerr<<"in function fold_momentum_rhside_u1 line 466 \n";
		  std::cerr<<"**************************************************** \n";
		  exit(1);
	      }
	  }
