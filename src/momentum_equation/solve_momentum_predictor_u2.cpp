...
/********************************************************************************/
      ...
      Array3<double> u_2_velocity_star,			// velocity field at star time level x1 direction
    ...
    void build_momentum_predictor_u2(			// build system of linear
      Array2<double> momentum_matrix_u2,			// equations for momentum equation velocity
      Array1<double> momentum_rhside_u2,			// in x2 direction
   ...
   int conjugate_gradient_method(			// solve linear system with conjugate gradient
      ...
      Array1<double> compressed_velocity_u2;		// compressed solution vector
    ...
    /* and compressed solution vector */
      ...
      momentum_rhside_u2.create(total_number_u_2_points);
      momentum_matrix_u2.create(number_matrix_connections, total_number_u_2_points); 
      preconditioner_matrix_M.create(total_number_u_2_points); 
      compressed_velocity_u2.create(total_number_u_2_points);
...
// 			    4, momentum_matrix_u2, momentum_rhside_u2, compressed_velocity_u2, "velocity_u2");
    ...
    /* deallocate memory for momentum matrix and rhside */
      ...
      momentum_rhside_u2.destroy();
      momentum_matrix_u2.destroy();
      preconditioner_matrix_M.destroy();
      compressed_velocity_u2.destroy();
      }
