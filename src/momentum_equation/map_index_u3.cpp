...
EXPORT int map_index_u3(
      ...
      )
  {
    ...
    /* in construction of the matrix and rhside for the u_3 matrix the */
    /* i and j index run from 1 to number_primary_cells_i/j to have a  */
    /* nice correspondence with the fields that do include the virtual */
    /* cells							       */
    
    one_dimensional_index=(i_index-1)+(j_index-1)*(number_primary_cells_i)+
		 k_index*(number_primary_cells_i*number_primary_cells_j);
