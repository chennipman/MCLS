...
/********************************************************************************/
    ...
    void build_momentum_predictor_u1(				// build system of linear
      double **momentum_matrix_u1,				// equations for momentum equation velocity
      double *momentum_rhside_u1,				// in x1 direction
      double ***level_set, 				
   ...
   int conjugate_gradient_method(		// solve linear system with conjugate gradient
      ...
      double  *compressed_velocity_u1;			// compressed solution vector
    ...
    /* and compressed solution vector */
      ...
      momentum_rhside_u1=double_Vector(total_number_u_1_points);
      momentum_matrix_u1=double_Matrix(number_matrix_connections,total_number_u_1_points); 
      preconditioner_matrix_M=double_Vector(total_number_u_1_points); 
      compressed_velocity_u1=double_Vector(total_number_u_1_points);
...
// 			    4, momentum_matrix_u1, momentum_rhside_u1, compressed_velocity_u1, "velocity_u1");
    ...
    /* deallocate memory for momentum matrix and rhside */
      ...
      free_double_Vector(momentum_rhside_u1);
      free_double_Matrix(momentum_matrix_u1, number_matrix_connections);
      free_double_Vector(preconditioner_matrix_M);
      free_double_Vector(compressed_velocity_u1);
      }