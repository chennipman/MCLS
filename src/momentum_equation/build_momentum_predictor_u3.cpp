...
EXPORT void build_momentum_predictor_u3(
    ...
    /* without considering the boundary conditions */
      ...
      build_momentum_matrix_u3( momentum_matrix_u3, level_set, scaled_density_u3, 
    ...
    /* without considering the boundary conditions */
      ...
      build_momentum_rhs_u3( momentum_rhside_u3, level_set, scaled_density_u3,				
    ...
    /* this has to be done first, because in that case the matrix can be utilised */
      ...
      fold_momentum_rhside_u3(boundary_faces,	
				momentum_rhside_u3, momentum_matrix_u3,			
				  number_primary_cells_i, number_primary_cells_j, number_primary_cells_k,			 
				    mesh_width_x1, mesh_width_x2, mesh_width_x3);
    ...
    /* apply boundary conditions to the momentum equation matrix for velocity u1 */
      ...
      fold_momentum_matrix_u3(boundary_faces,			
				momentum_matrix_u3,		
				  number_primary_cells_i, number_primary_cells_j, number_primary_cells_k,
