	  ...
	  /* write the level-set field */
 	  ...
 	  final_index_k=number_primary_cells_k+1;
		...
		for(j_index=0;j_index<final_index_j+1;j_index++)
		  ...
		  OutputFile.write((char *) level_set[i_index][j_index],
	  ...
	  /* write the volume of fluid field */
 	  ...
 	  final_index_k=number_primary_cells_k+1;
		...
		for(j_index=0;j_index<final_index_j+1;j_index++)
		  ...
		  OutputFile.write((char *) volume_of_fluid[i_index][j_index],
					  sizeof(double) * (final_index_k+1));
 	  ...
 	  final_index_k=number_primary_cells_k+1;
		...
		for(j_index=0;j_index<final_index_j+1;j_index++)
		  ...
		  OutputFile.write((char *) u_1_velocity[i_index][j_index],
					  sizeof(double) * (final_index_k+1));
	  ...
	  /* write the velocity field in 2 - direction */
 	  ...
 	  final_index_k=number_primary_cells_k+1;
		...
		for(j_index=0;j_index<final_index_j+1;j_index++)
		  ...
		  OutputFile.write((char *) u_2_velocity[i_index][j_index],
					  sizeof(double) * (final_index_k+1));
	  ...
	  /* write the velocity field in 3 - direction */
 	  ...
 	  final_index_k=number_primary_cells_k;
		...
		for(j_index=0;j_index<final_index_j+1;j_index++)
		  ...
		  OutputFile.write((char *) u_3_velocity[i_index][j_index],
					  sizeof(double) * (final_index_k+1));
	  ...
	  /* write the pressure field */
 	  ...
 	  final_index_k=number_primary_cells_k+1;
		...
		for(j_index=0;j_index<final_index_j+1;j_index++)
		  ...
		  OutputFile.write((char *) pressure[i_index][j_index],
					  sizeof(double) * (final_index_k+1));
