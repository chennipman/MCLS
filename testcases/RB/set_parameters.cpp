...
/*-------------------------------------------------------------------------------------------------*/
      ...
      cfl_number_navier_stokes			= 0.5; 
      time_step_restriction_global			= 0.00001;      
      actual_time_step_navier_stokes    		= time_step_restriction_global;
      time_interval_for_output				= time_step_restriction_global*1000;
      ...
      /* grid parameters */
      number_primary_cells_i=270;		
      number_primary_cells_j=1;	
      number_primary_cells_k=540;	
      ...
      the_bubbles[0].principle_axis_x1	 			= 0.25;
      the_bubbles[0].principle_axis_x2	 			= 0.25; //2D-flow 
      the_bubbles[0].principle_axis_x3	 			= 0.25;
      the_bubbles[0].center_location.x1  				= 0.5;
      the_bubbles[0].center_location.x2  				= 0.5*domain_size_x2;
 //     the_bubbles[0].center_location.x3  				= 0.5*domain_size_x3;
      the_bubbles[0].center_location.x3  				= 0.5;
      number_of_bubbles			 			= 1;
      ...
      mu_plus_over_mu_minus		 	=10.0;
      rho_plus_over_rho_minus		 	=10.0;	
      sigma_over_rho_minus		 	=24.5/100.0;
